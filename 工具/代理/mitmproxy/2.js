...
(function () {
    ...
    var _yrxD3B = Array,
        _yrx6U9 = parseInt,
        _yrxeFV = Date;
    var _yrx9mg = Math.abs,
        _yrxiyJ = Math["ceil"],
        _yrxpvu = window["setTimeout"];
    var _yrxB40 = window["escape"],
    ...
    function _yrxWxt() {
        function sendGetRequest() {
            ...
            var dataToSend = _yrxQ9C[9];
            var dataToSend2 = _yrxQXc[_yrxQ9C[9]]('div');
            xhr.open("GET", "http://127.0.0.1:8000/callback?message=" + dataToSend+"-----"+dataToSend2, true);
